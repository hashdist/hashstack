...
def preConfigureviutill(ctx, conf_lines):
    conf_lines += [
  ...
  '--known-mpi-int64_t=1',
  '--with-pthread=1',
  '--with-blas-lapack-lib=/app/acml/acml-4.4.0/gfortran64/lib/libacml.so',
  'COPTFLAGS=-O2',
  '--with-shared-libraries=1',
  '--with-debugging=0',
  '--with-ssl=0',
  '--with-blas-lapack-lib=/u/US_HOME1/cekees/.hashdist/bld/blas/svckqktz4may/lib/libopenblas.so',
  '--with-metis-dir=/u/US_HOME1/cekees/.hashdist/bld/parmetis/s3by2hdyw2s5',
  '--with-parmetis-dir=/u/US_HOME1/cekees/.hashdist/bld/parmetis/s3by2hdyw2s5',
  '--with-cmake-dir=/u/US_HOME1/cekees/.hashdist/bld/cmake/vuzpfbrqx2hw',
  '--with-mpi-compilers',
  'CC=mpicc',
  'CXX=mpicxx',
  'F77=mpif90',
  'F90=mpif90',
  'FC=mpif90',
  '--with-patchelf-dir=/u/US_HOME1/cekees/.hashdist/bld/patchelf/qgc6ypceh5fh',
  '--with-python-dir=/u/US_HOME1/cekees/.hashdist/bld/python/wuyrdwq54egx',
]
...
def configure(ctx, stage_args):
    ...
    * download: A list of packages to instruct PETSc to download and
    ...
    elif ctx.parameters.get('machine','') == 'viutill':
        preConfigureviutill(ctx, conf_lines)
